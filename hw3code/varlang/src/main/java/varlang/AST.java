...
public interface AST {
	...
	public static class dec extends CompoundArithExp {
		public dec(Exp fst) {
			super(fst);
		}

		public dec(List<Exp> args) {
			super(args);
		}

		public dec(Exp fst, List<Exp> rest) {
			super(fst, rest);
		}

		public dec(Exp left, Exp right) {
			super(left, right);
		}
	...
	public static class letunique extends Exp {
		List<String> _names;
		List<Exp> _value_exps;
		Exp _body;

		public letunique(List<String> names, List<Exp> value_exps, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
		}
	...
	public static class lete extends Exp {
		List<String> _names;
		List<Exp> _value_exps;
		Exp _body;

		public lete(List<String> names, List<Exp> value_exps, Exp body) {
			_names = names;
			_value_exps = value_exps;
			_body = body;
		}
	...
	public interface Visitor <T> {
		...
		public T visit(AST.dec e, Env env); // DEC
		public T visit(AST.LetExp e, Env env); // New for the varlang
		public T visit(AST.letunique e, Env env); // LETUNIQUE
		public T visit(AST.lete e, Env env); // LETE
	}	
}
