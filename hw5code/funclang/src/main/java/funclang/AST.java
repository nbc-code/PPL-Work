...
public interface AST {
	...
	public static class SwitchExp extends Exp {
		private Exp _e0;
		private Exp _defbody;
		private List<Exp> _elems;
		private List<Exp> _bodys;

		public SwitchExp(Exp e0, List<Exp> elems, List<Exp> bodys, Exp defbody){
			_e0 = e0;
			_defbody = defbody;
			_elems = elems;
			_bodys = bodys;
		...
		public Exp defbody() { return _defbody; }
		public List<Exp> elems() { return _elems; }
		public List<Exp> bodys() { return _bodys; }
		public Object accept(Visitor visitor, Env env) {
			return visitor.visit(this, env);
		}
	}
